...
class MyAccount extends Component {
	...
	updateMyData = (e) => {
		...
		this.props.updateUser(updatedData, this.props.history);
	}
					...
					<div className="row">
						<div className="col s8 offset-s2 ">
							...
							<div className="col s12" style={{ paddingLeft: "11.250px" }}>
								<h4><b>Update My Account</b></h4>
							</div>
							<form noValidate onSubmit={this.updateMyData}>
								...
								<div className="input-field col s12">
									...
									<span className="red-text">{errors.email} {errors.emailTaken}</span>
								</div>
								<div className="input-field col s12">
